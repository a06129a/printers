...
class CostosView:
    ...
    def view(self):
        ...
        async def ir_a_orden_pedido(e):
            guardar_datos(e)
            await self.page.shared_preferences.set("documento_cliente", self.documento_cliente)  # Guardar documento
                ...
                ft.Container(
                    ...
                    content=ft.Column([
                        ...
                        ft.Row([
                            ...
                            ft.ElevatedButton("Orden pedido", bgcolor="#1536f1", color="white", on_click=ir_a_orden_pedido)
